...
const minhasEspecialidades = {
  arquitetura: ['Microsserviços', 'APIs RESTful', 'GraphQL'],
  frontend: ['SPAs', 'SSR', 'PWAs', 'Responsive Design'],
  backend: ['Escalabilidade', 'Performance', 'Segurança'],
  database: ['Modelagem', 'Otimização', 'Migrations'],
  integracoes: ['APIs Third-Party', 'Webhooks', 'Sistema Legado'],
  devops: ['CI/CD', 'Containerização', 'Cloud Deploy'],
...
<div align="center">
  ...
  **"Código limpo não é escrito seguindo regras. Você reconhece código limpo quando o lê."** - *Robert C. Martin*
